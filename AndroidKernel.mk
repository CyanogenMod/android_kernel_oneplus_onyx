...
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/project/14001_HW/$(DTS_NAME)*.dts)
DTS_FILES += $(wildcard $(TOP)/kernel/arch/arm/boot/dts/project/15055_HW_11/$(DTS_NAME)*.dts)
DTS_FILES += $(wildcard $(TOP)/kernel/arch/arm/boot/dts/project/15055_HW_12/$(DTS_NAME)*.dts)
DTS_FILES += $(wildcard $(TOP)/kernel/arch/arm/boot/dts/project/15055_HW_13/$(DTS_NAME)*.dts)
DTS_FILES += $(wildcard $(TOP)/kernel/arch/arm/boot/dts/project/15055_HW_14/$(DTS_NAME)*.dts)
DTS_FILES += $(wildcard $(TOP)/kernel/arch/arm/boot/dts/project/15055_HW_15/$(DTS_NAME)*.dts)
