...
enum {
	...
	POWER_SUPPLY_HEALTH_LITTLE_COLD,
	POWER_SUPPLY_HEALTH_LITTLE_COOL,
};

#ifdef CONFIG_VENDOR_EDIT
enum {
	POWER_SUPPLY_TEMP_UNKNOWN = 0,
	POWER_SUPPLY_TEMP_NORMAL = POWER_SUPPLY_TEMP_UNKNOWN,
	POWER_SUPPLY_TEMP_OVERHEAT,
	POWER_SUPPLY_TEMP_WARM,
	POWER_SUPPLY_TEMP_COLD,
	POWER_SUPPLY_TEMP_COOL,
	POWER_SUPPLY_TEMP_LITTLE_COLD,
	POWER_SUPPLY_TEMP_LITTLE_COOL,
};
#endif
